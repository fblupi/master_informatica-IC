...
public class RedNeuronal {
    ...
    private final double RATIO_APRENDIZAJE = 0.9;
    ...
    public RedNeuronal() {
        ...
        for (int i = 0; i < NUM_ENTRADAS; i++) {
            ...
            for (int j = 0; j < NUM_ENTRADAS; j++) {
                neurona.addSinapsis(capaEntrada.get(j), random.nextDouble() * 3.46 - 1.73);
            }
        ...
        for (int i = 0; i < NUM_ENTRADAS; i++) {
            neuronaSalida.addSinapsis(capaOculta.get(i), random.nextDouble() * 3.46 - 1.73);
        }
    }
    ...
    public void entrenarImagen(float[][] imagen, int resultado) {
        ...
        System.out.println("RESULTADO ESPERADO: " + resultado + ", RESULTADO " + neuronaSalida.getValor() + ", ERROR: " + error);
